...
public class RegistrationAuthorizationTest extends Chromerunner {
    ...
    public void registration_Test(){
        ...
        Assert.assertTrue((regAuthorizationPage.reg_phone_number_input).is(Condition.visible));
        Assert.assertTrue((regAuthorizationPage.read_and_agree_text).is(Condition.visible));
        Assert.assertTrue((regAuthorizationPage.other_registration).is(Condition.visible));
        ...
        Assert.assertTrue((regAuthorizationPage.confirm_number).is(Condition.visible));
    }
    @Test
    public void registration_mandate_Test(){
        ...
        regAuthorizationPageStep.agree_terms_and_conditions();
        regAuthorizationPageStep.registration_button_click();
        Assert.assertTrue((regAuthorizationPage.mandate).is(Condition.visible));
    }
    ...
    public void authorization_by_number_Test(){
        ...
        Assert.assertTrue((regAuthorizationPage.confirm_code).is(Condition.visible));
    }
    @Test
    ...
    public void authorization_by_email_Test(){
        ...
        Assert.assertTrue((regAuthorizationPage.forgot_password).is(Condition.visible));
        ...
        Assert.assertTrue((regAuthorizationPage.invalid_username_or_password).is(Condition.visible));
    }
    @Test
